...
/**
 * Generated from protobuf message <code>com.fatehan.services.DriverBehaviorReportRequest</code>
 */
class DriverBehaviorReportRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * Generated from protobuf field <code>.com.fatehan.services.DriverBehaviorReportRequest.GroupBy group_by = 2 [json_name = "group_by"];</code>
     */
    ...
    /**
     * Generated from protobuf field <code>.com.fatehan.services.DriverBehaviorReportRequest.GroupBy group_by = 2 [json_name = "group_by"];</code>
     * @return int one of the values in {@see \Fatehan\Service\DriverBehaviorReportRequest\GroupBy}
     */
    ...
    /**
     * Generated from protobuf field <code>.com.fatehan.services.DriverBehaviorReportRequest.GroupBy group_by = 2 [json_name = "group_by"];</code>
     * @param int $var one of the values in {@see \Fatehan\Service\DriverBehaviorReportRequest\GroupBy}
     * @return $this
     */
    public function setGroupBy(int $var)
    {
        GPBUtil::checkEnum($var, \Fatehan\Service\DriverBehaviorReportRequest\GroupBy::class);
        $this->group_by = $var;
