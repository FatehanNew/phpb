...
/**
 * Generated from protobuf message <code>com.fatehan.services.EventTemplateIndexRequest</code>
 */
class EventTemplateIndexRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * Generated from protobuf field <code>bool disable_pagination = 2 [json_name = "disable_pagination"];</code>
     */
    protected $disable_pagination = false;
    /**
     * Generated from protobuf field <code>optional string search = 3 [json_name = "search"];</code>
     */
    protected $search = null;
    /**
     * Generated from protobuf field <code>optional uint32 page = 4 [json_name = "page"];</code>
     */
    protected $page = null;
    /**
     * Generated from protobuf field <code>optional uint32 page_size = 5 [json_name = "page_size"];</code>
     */
    protected $page_size = null;
    /**
     * Generated from protobuf field <code>optional uint64 organization_id = 6 [json_name = "organization_id"];</code>
     */
    protected $organization_id = null;
    /**
     * Generated from protobuf field <code>map<string, .com.fatehan.services.FilterScope> query_filter = 7 [json_name = "query_filter"];</code>
     */
    private $query_filter;
    /**
     * Generated from protobuf field <code>optional string sort = 8 [json_name = "sort"];</code>
     */
    protected $sort = null;
    /**
     * Generated from protobuf field <code>optional string order = 9 [json_name = "order"];</code>
     */
