...
class Notify extends \Google\Protobuf\Internal\Message
{
    ...
    private $data;
    /**
     * Generated from protobuf field <code>repeated string alert_ids = 12 [json_name = "alert_ids"];</code>
     */
    private $alert_ids;
     ...
     *     @type array<string>|\Google\Protobuf\Internal\RepeatedField $alert_ids
     * }
     */
     ...
     * @return $this
     */
    public function setAlertIds($var)
    {
